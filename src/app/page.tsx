...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100 selection:bg-indigo-500 selection:text-white relative overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-2">
          <Link href="/" className="flex items-center space-x-2.5 sm:space-x-3.5 group flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-[11px] text-slate-400 font-medium leading-none hidden md:block">AI Job Discovery & Direct Outreach</p>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <Link
              href="/creator"
              className="hidden sm:flex items-center space-x-2 text-xs font-semibold text-emerald-400 hover:text-emerald-300 px-3 sm:px-3.5 py-2 rounded-xl border border-emerald-500/30 bg-emerald-500/10 hover:bg-emerald-500/20 transition"
            >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-16 space-y-16 sm:space-y-28 relative">

        {/* 1. Hero Section */}
        <section className="text-center max-w-4xl mx-auto space-y-5 sm:space-y-7">
          <div className="inline-flex items-center space-x-2.5 px-3.5 sm:px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-[11px] sm:text-xs font-semibold">
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
            <span>Open Source Remote AI Job Hunter</span>
          </div>

          <h1 className="text-3xl xs:text-4xl sm:text-6xl font-black tracking-tight text-white leading-tight">
          ...
          <div className="max-w-2xl mx-auto p-3 sm:p-4 rounded-2xl bg-slate-900/90 border border-slate-800 backdrop-blur-md shadow-2xl flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-1">
            <button
              onClick={handleStart}
              className="w-full sm:w-auto flex items-center justify-center space-x-2 bg-slate-900 hover:bg-slate-800 text-slate-200 font-bold text-xs sm:text-sm px-6 sm:px-7 py-3 rounded-xl border border-slate-800 hover:border-slate-700 transition cursor-pointer"
            >
          ...
          {/* Social Proof Stats */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-4 pt-8 sm:pt-10 border-t border-slate-800 text-left">
            <div className="p-3 sm:p-4 rounded-2xl bg-slate-900/80 border border-slate-800">
              <div className="text-xl sm:text-2xl font-black text-white">100%</div>
              <div className="text-[11px] sm:text-xs text-slate-400 mt-0.5">Open-Source & BYOK</div>
            </div>
            <div className="p-3 sm:p-4 rounded-2xl bg-slate-900/80 border border-slate-800">
              <div className="text-xl sm:text-2xl font-black text-emerald-400">0 Bans</div>
              <div className="text-[11px] sm:text-xs text-slate-400 mt-0.5">Zero account restrictions</div>
            </div>
            <div className="p-3 sm:p-4 rounded-2xl bg-slate-900/80 border border-slate-800">
              <div className="text-xl sm:text-2xl font-black text-indigo-400">4+ Models</div>
              <div className="text-[11px] sm:text-xs text-slate-400 mt-0.5">GPT-4o, Claude, Gemini, Grok</div>
            </div>
            <div className="p-3 sm:p-4 rounded-2xl bg-slate-900/80 border border-slate-800">
              <div className="text-xl sm:text-2xl font-black text-purple-400">1-Click</div>
              <div className="text-[11px] sm:text-xs text-slate-400 mt-0.5">Tailored email dispatch</div>
            </div>
          </div>
        </section>

        {/* 2. The Problem We Solve (High Contrast Dark Slate) */}
        <section className="p-5 sm:p-8 sm:p-12 rounded-3xl bg-slate-900/90 border border-slate-800 backdrop-blur-md shadow-2xl space-y-6 sm:space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/90 border border-slate-800/90 hover:border-rose-500/40 transition space-y-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-rose-500/10 text-rose-400 flex items-center justify-center text-lg sm:text-xl border border-rose-500/20">
                <i className="fa-solid fa-ghost"></i>
              </div>
              <h3 className="text-base sm:text-lg font-bold text-white">Ghost Postings & Reseller Scraping</h3>
            ...
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/90 border border-slate-800/90 hover:border-amber-500/40 transition space-y-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-amber-500/10 text-amber-400 flex items-center justify-center text-lg sm:text-xl border border-amber-500/20">
                <i className="fa-solid fa-earth-americas"></i>
              </div>
              <h3 className="text-base sm:text-lg font-bold text-white">"Remote" Location Bait-and-Switch</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            ...
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/90 border border-slate-800/90 hover:border-indigo-500/40 transition space-y-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-indigo-500/10 text-indigo-400 flex items-center justify-center text-lg sm:text-xl border border-indigo-500/20">
                <i className="fa-solid fa-inbox"></i>
              </div>
              <h3 className="text-base sm:text-lg font-bold text-white">Recruiter Inboxes Hidden in Plain Sight</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            ...
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/90 border border-slate-800/90 hover:border-purple-500/40 transition space-y-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-purple-500/10 text-purple-400 flex items-center justify-center text-lg sm:text-xl border border-purple-500/20">
                <i className="fa-solid fa-robot"></i>
              </div>
              <h3 className="text-base sm:text-lg font-bold text-white">AI Mass-Spam Getting Auto-Filtered</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            ...
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/90 border border-slate-800/90 hover:border-emerald-500/40 transition space-y-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center text-lg sm:text-xl border border-emerald-500/20">
                <i className="fa-solid fa-coins"></i>
              </div>
              <h3 className="text-base sm:text-lg font-bold text-white">Predatory SaaS Subscriptions</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            ...
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/90 border border-slate-800/90 hover:border-cyan-500/40 transition space-y-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-cyan-500/10 text-cyan-400 flex items-center justify-center text-lg sm:text-xl border border-cyan-500/20">
                <i className="fa-solid fa-filter-circle-xmark"></i>
              </div>
              <h3 className="text-base sm:text-lg font-bold text-white">Zero Custom Stack Matching</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
        ...
        <section className="p-5 sm:p-8 sm:p-12 rounded-3xl bg-gradient-to-b from-slate-900 via-indigo-950/40 to-slate-900 border border-indigo-900/50 space-y-6 sm:space-y-10">
          <div className="max-w-3xl space-y-2">
            <span className="text-xs font-bold uppercase tracking-widest text-indigo-400">Agentic Architecture</span>
            <h2 className="text-2xl sm:text-4xl font-black text-white">How GetHired Solves It: The 3-Stage Pipeline</h2>
            <p className="text-xs sm:text-base text-slate-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3 relative overflow-hidden">
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-indigo-600 text-white font-bold flex items-center justify-center text-xs sm:text-sm shadow-md">1</div>
              <h4 className="font-bold text-white text-base sm:text-lg">Direct ATS Ingestion</h4>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            ...
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3 relative overflow-hidden">
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-indigo-600 text-white font-bold flex items-center justify-center text-xs sm:text-sm shadow-md">2</div>
              <h4 className="font-bold text-white text-base sm:text-lg">Deterministic Pre-Filter</h4>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            ...
            <div className="p-5 sm:p-7 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3 relative overflow-hidden">
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-indigo-600 text-white font-bold flex items-center justify-center text-xs sm:text-sm shadow-md">3</div>
              <h4 className="font-bold text-white text-base sm:text-lg">Semantic Scoring & Outreach</h4>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
        ...
        <section className="space-y-6 sm:space-y-8">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white">Traditional Job Search vs GetHired</h2>
            <p className="text-xs sm:text-sm text-slate-300">See the difference an autonomous copilot makes in your daily search.</p>
          </div>

          <div className="overflow-x-auto rounded-2xl border border-slate-800 bg-slate-900/60 shadow-xl">
            <table className="w-full text-left text-xs sm:text-sm text-slate-300 min-w-[500px]">
              <thead className="bg-slate-950/80 text-[11px] sm:text-xs uppercase font-bold text-slate-400 border-b border-slate-800">
                <tr>
                  <th className="py-3 sm:py-4 px-4 sm:px-6">Feature</th>
                  <th className="py-3 sm:py-4 px-4 sm:px-6 text-slate-400">LinkedIn / Indeed</th>
                  <th className="py-3 sm:py-4 px-4 sm:px-6 text-indigo-400">GetHired Copilot</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-800">
                <tr className="hover:bg-slate-800/30 transition">
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 font-semibold text-white">Ghost Job Elimination</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-rose-400">❌ High (30–60% stale)</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-emerald-400 font-bold">✅ Direct ATS verification</td>
                </tr>
                <tr className="hover:bg-slate-800/30 transition">
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 font-semibold text-white">Location Bait Filtering</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-rose-400">❌ Manual reading required</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-emerald-400 font-bold">✅ Deterministic regex blocks "US-only"</td>
                </tr>
                <tr className="hover:bg-slate-800/30 transition">
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 font-semibold text-white">Hidden Recruiter Inboxes</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-rose-400">❌ Buried in feeds</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-emerald-400 font-bold">✅ Scraped from hiring posts automatically</td>
                </tr>
                <tr className="hover:bg-slate-800/30 transition">
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 font-semibold text-white">Application Customization</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-slate-400">Manual / Generic Easy Apply</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-emerald-400 font-bold">✅ Tailored pitch citing your exact portfolio</td>
                </tr>
                <tr className="hover:bg-slate-800/30 transition">
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 font-semibold text-white">Cost & Data Privacy</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-slate-400">Data harvested / $40+ mo</td>
                  <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-emerald-400 font-bold">✅ 100% Open-Source, Local SQLite & BYOK</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="space-y-6 sm:space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white">Start Hunting in 3 Minutes</h2>
            <p className="text-xs sm:text-sm text-slate-300">Zero complicated setup. Works right out of the box.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="p-5 sm:p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-2.5 sm:space-y-3">
              ...
              <h3 className="font-bold text-white text-sm sm:text-base">Set Your Profile & Stack</h3>
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-2.5 sm:space-y-3">
              ...
              <h3 className="font-bold text-white text-sm sm:text-base">Connect Your AI Key (BYOK)</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-2.5 sm:space-y-3">
              ...
              <h3 className="font-bold text-white text-sm sm:text-base">Autonomously Scrape & Pitch</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <section className="p-5 sm:p-8 sm:p-10 rounded-3xl bg-gradient-to-r from-slate-900 via-slate-900/95 to-slate-900 border border-slate-800 shadow-2xl relative overflow-hidden">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-5 sm:gap-6 text-center sm:text-left">
            ...
            <div className="flex items-center space-x-3 w-full sm:w-auto flex-shrink-0">
              <Link
                href="/creator"
                className="w-full sm:w-auto flex items-center justify-center space-x-2 bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white font-bold text-xs sm:text-sm px-5 py-3 rounded-xl shadow-lg shadow-emerald-600/30 transition transform whitespace-nowrap"
              >
      ...
      {/* Footer */}
      <footer className="border-t border-slate-800 bg-slate-950 py-8 sm:py-12 mt-12 sm:mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400 text-center sm:text-left">
          <div className="flex items-center space-x-2.5 sm:space-x-3">
            <img src="/logo.svg" alt="Logo" className="w-5 h-5 sm:w-6 sm:h-6" />
